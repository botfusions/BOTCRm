...
// ⚡ PERFORMANCE OPTIMIZATION: Memoized card component to prevent unnecessary re-renders in the grid view
const CompanyCard: React.FC<{
    ...
    <div className={`p-6 rounded-3xl border transition-all hover:border-indigo-500/30 group ${bgCard} hover:shadow-xl hover:scale-[1.01]`}>
        <div className="flex items-center gap-5 mb-6">
            <img src={company.logoUrl} className="w-16 h-16 rounded-2xl object-cover border border-slate-100 shadow-sm" alt={company.name} />
            <div>
        ...
        <div className="pt-4 border-t border-slate-100 dark:border-slate-800 flex justify-between items-center">
            <span className={`px-4 py-1 rounded-xl text-[9px] font-black uppercase border shadow-sm
             ...
             <button className={`p-2 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 ${textSub}`} aria-label="More options">
...
// ⚡ PERFORMANCE OPTIMIZATION: Memoized row component to prevent full table re-renders during search
    ...
    <tr className="hover:bg-indigo-500/5 transition-colors group">
        <td className="p-5">
            <div className="flex items-center gap-3">
                <img src={company.logoUrl} className="w-8 h-8 rounded-lg" alt="" />
