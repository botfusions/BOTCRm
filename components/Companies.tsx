        ...
        <div className="flex items-center gap-5 mb-6">
            <img
                ...
                className="w-16 h-16 rounded-2xl object-cover border border-slate-100 shadow-sm"
                    // ⚡ PERFORMANCE OPTIMIZATION: Lazy loading images to improve initial page load speed
                loading="lazy"
            />
            <div>
...
// ⚡ PERFORMANCE OPTIMIZATION: Memoized table row component to optimize large list rendering
const CompanyRow: React.FC<{
    company: Company;
    textMain: string;
}> = React.memo(({ company: c, textMain }) => (
