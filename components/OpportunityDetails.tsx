...
/**
 * ⚡ PERFORMANCE OPTIMIZATION: Static configurations hoisted outside the component scope
 * to prevent unnecessary garbage collection overhead and object re-allocations on every render.
 */
const STAGES_DATA = [
...
/**
 * ⚡ PERFORMANCE OPTIMIZATION: Extracting ContactCard as a memoized sub-component.
 * This prevents the entire contacts sub-tree from re-rendering unless the properties change.
 */
...
const ContactCard: React.FC<ContactCardProps> = React.memo(({ contact, bgCard, textMain, textSub }) => (
  <div className={`rounded-xl border p-4 shadow-sm mb-3 ${bgCard}`}>
       ...
       <div className="flex items-center gap-3 mb-4">
          <img src={contact.avatar} className="w-10 h-10 rounded-full" loading="lazy" />
          <div>
