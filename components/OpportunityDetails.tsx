...
/*
  ...
  1. Hoisted static STAGES and CONTACTS_DATA arrays outside the component scope to avoid array allocations on re-renders.
  2. Extracted ContactCard component and wrapped in React.memo to prevent unnecessary re-renders.
  3. Added loading="lazy" to external img elements for lazy loading assets.
  4. Wrapped OpportunityDetails in React.memo to optimize parent App reconciliation.
*/
...
const ContactCard: React.FC<{
  ...
  return (
    <div className={`rounded-xl border p-4 shadow-sm mb-3 ${bgCard}`}>
      <div className={`inline-block px-2 py-0.5 ${contact.roleColorClass} text-[10px] font-bold uppercase tracking-wider rounded mb-3`}>
        {contact.role}
      </div>
