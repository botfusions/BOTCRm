...
// ⚡ PERFORMANCE OPTIMIZATION: Hoisting static data outside component scope to avoid allocations on re-renders
const STAGES = [
...
// ⚡ PERFORMANCE OPTIMIZATION: Extracting ContactCard into React.memo to isolate rendering and lazy load images
const ContactCard = React.memo(({
  ...
  contact: typeof CONTACTS_DATA[number];
  bgCard: string;
  textMain: string;
  textSub: string;
}) => (
...
// ⚡ PERFORMANCE OPTIMIZATION: Wrapping component in React.memo to prevent unnecessary re-renders
