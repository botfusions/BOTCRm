...
// ⚡ PERFORMANCE OPTIMIZATION: Hoisting static data outside component scope to eliminate re-allocation on every render
const STAGES = [
...
// ⚡ PERFORMANCE OPTIMIZATION: Memoizing ContactCard sub-component to isolate contact updates and lazy load avatar images
...
const OpportunityDetails: React.FC<OpportunityDetailsProps> = ({ darkMode, language, onBack }) => {
  const bgCard = darkMode ? 'bg-slate-900 border-slate-800' : 'bg-[#ffffff] border-slate-200';
