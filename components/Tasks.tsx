...
// ⚡ PERFORMANCE OPTIMIZATION: Extracting task rows into a React.memo'd component
// prevents unnecessary re-renders of the entire list when the parent state
// (like search input or new task form) changes.
...
const Tasks: React.FC<TasksProps> = ({ darkMode }) => {
  ...
  // ⚡ PERFORMANCE OPTIMIZATION: Stabilizing data loader with useCallback to prevent
  // redundant effect triggers and maintain referential integrity for child components.
  ...
  // ⚡ PERFORMANCE OPTIMIZATION: Memoized toggle handler using functional updates
  // to avoid dependency on the 'tasks' state array, ensuring the callback
  ...
  // ⚡ PERFORMANCE OPTIMIZATION: Memoized add handler to prevent unnecessary
