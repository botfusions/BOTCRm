...
// ⚡ PERFORMANCE OPTIMIZATION: Extracting TaskItem into a memoized component
// prevents redundant re-renders of the entire task list when unrelated state
// (like the 'New Task' input) changes.
