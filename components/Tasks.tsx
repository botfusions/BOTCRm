...
/**
 * ⚡ PERFORMANCE OPTIMIZATION: TaskItem
 * Extracted into a memoized component to prevent redundant re-renders of the entire list
 * when parent state (like the 'New Task' input or modal visibility) changes.
 */
...
const Tasks: React.FC<TasksProps> = ({ darkMode }) => {
  ...
  /**
   * ⚡ PERFORMANCE OPTIMIZATION: loadTasks
   * Stabilized with useCallback to maintain reference consistency across re-renders.
   */
  ...
  /**
   * ⚡ PERFORMANCE OPTIMIZATION: toggleTask
   * Uses functional state updates and useCallback to prevent unnecessary closure dependencies.
   */
  ...
  /**
   * ⚡ PERFORMANCE OPTIMIZATION: handleAddTask
   * Uses functional state updates to keep the dependency array minimal.
   */
