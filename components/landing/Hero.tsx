...
/**
 * ⚡ PERFORMANCE OPTIMIZATION: Memoized ElegantShape to prevent expensive re-renders
 * during parent state changes, as it contains heavy motion animations.
 */
...
/**
 * ⚡ PERFORMANCE OPTIMIZATION: Memoized Hero component to prevent re-renders
 * when the parent (LandingPage) state (like isAuthOpen) changes.
 */
const Hero: React.FC<HeroProps> = React.memo(({ onStart, language }) => {
    const txt = HERO_CONTENT[language];
        ...
        <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-[#030303]">
            ...
            <div className="relative z-10 container mx-auto px-4 md:px-6 pointer-events-none">
                <div className="max-w-3xl mx-auto text-center pointer-events-auto">
                    <motion.div custom={1} variants={FADE_UP_VARIANTS} initial="hidden" animate="visible">
                    ...
                    <motion.div custom={2} variants={FADE_UP_VARIANTS} initial="hidden" animate="visible">
                    ...
                    <motion.div custom={3} variants={FADE_UP_VARIANTS} initial="hidden" animate="visible">
